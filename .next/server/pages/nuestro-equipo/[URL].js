...
class SocialNetworks extends external_react_.Component {
    ...
    render() {
        const linkedin = this.props.linkedin ? this.renderImageElement(this.props.linkedin, highlights_mail/* default */.Z, "Haz click para ver la p\xe1gina de LinkedIn de este autor.") : /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {});
        const twitter = this.props.twitter ? this.renderImageElement(this.props.twitter, highlights_twitter/* default */.Z, "Haz click para ver el feed de Twitter de este autor.") : /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {});
        const instagram = this.props.instagram ? this.renderImageElement(this.props.instagram, highlights_instagram/* default */.Z, "Haz click para ver la p\xe1gina de Instagram de este autor.") : /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {});
        const facebook = this.props.facebook ? this.renderImageElement(this.props.facebook, highlights_youtube/* default */.Z, "Haz click para ver el canal de YouTube de este autor.") : /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {});
...
;// CONCATENATED MODULE: ./pages/nuestro-equipo/[URL]/index.tsx
...
var __webpack_exports__ = __webpack_require__.X(0, [398,675,505,664,553,927,337,441,46,642], () => (__webpack_exec__(3711)));
